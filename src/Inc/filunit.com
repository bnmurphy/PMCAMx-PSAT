...
c-----------Add by Kristina Wagstrom 08/18/2006-------------------------
c     iAppiP -- Apportionment input file - point
c     iAppiA -- Apportionment input file - area
c     iAppo  -- Apportionment output file
c     iAppoA -- Apportionment average output file
c     iAppinst- Apportionment instantaneous input file
