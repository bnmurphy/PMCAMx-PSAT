...
c
      ...
      if(ldark) then
        if (conc(kno).le.bdnl(kno)) then
          nstrt=2
          NO2case=1 !Added by Kristina 07/18/07
        ...
        elseif (conc(ko3).le.conc(kno)) then
          ...
          NO2case=2 !Added by Kristina 07/18/07
          NO2cons(3)=tmp !Added by Kristina 07/18/07
        else
          ...
          nstrt = 2
          NO2case=3 !Added by Kristina 07/18/07
          NO2cons(3)=tmp !Added by Kristina 07/18/07
        endif
      endif
c
