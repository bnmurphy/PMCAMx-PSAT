...
c
     ...
     &(kmap(106),ksoa1_9  ),(kmap(107),ksoa1_10 ),(kmap(108),ksoa2_1  ),
     &(kmap(109),ksoa2_2  ),(kmap(110),ksoa2_3  ),(kmap(111),ksoa2_4  ),
     &(kmap(112),ksoa2_5  ),(kmap(113),ksoa2_6  ),(kmap(114),ksoa2_7  ),
     &(kmap(115),ksoa2_8  ),(kmap(116),ksoa2_9  ),(kmap(117),ksoa2_10 ),
     &(kmap(118),ksoa3_1  ),(kmap(119),ksoa3_2  ),(kmap(120),ksoa3_3  ),
     &(kmap(121),ksoa3_4  ),(kmap(122),ksoa3_5  ),(kmap(123),ksoa3_6  ),
     &(kmap(124),ksoa3_7  ),(kmap(125),ksoa3_8  ),(kmap(126),ksoa3_9  ),
     &(kmap(127),ksoa3_10 ),(kmap(128),ksoa4_1  ),(kmap(129),ksoa4_2  ),
     &(kmap(130),ksoa4_3  ),(kmap(131),ksoa4_4  ),(kmap(132),ksoa4_5  ),
     &(kmap(133),ksoa4_6  ),(kmap(134),ksoa4_7  ),(kmap(135),ksoa4_8  ),
     &(kmap(136),ksoa4_9  ),(kmap(137),ksoa4_10 ),(kmap(138),kpoc_1   ),
     &(kmap(139),kpoc_2   ),(kmap(140),kpoc_3   ),(kmap(141),kpoc_4   ),
     &(kmap(142),kpoc_5   ),(kmap(143),kpoc_6   ),(kmap(144),kpoc_7   ),
     &(kmap(145),kpoc_8   ),(kmap(146),kpoc_9   ),(kmap(147),kpoc_10  ),
     &(kmap(148),kpec_1   ),(kmap(149),kpec_2   ),(kmap(150),kpec_3   ),
     &(kmap(151),kpec_4   ),(kmap(152),kpec_5   ),(kmap(153),kpec_6   ),
     &(kmap(154),kpec_7   ),(kmap(155),kpec_8   ),(kmap(156),kpec_9   ),
     &(kmap(157),kpec_10  ),(kmap(158),kcrust_1 ),(kmap(159),kcrust_2 ),
     &(kmap(160),kcrust_3 ),(kmap(161),kcrust_4 ),(kmap(162),kcrust_5 ),
     &(kmap(163),kcrust_6 ),(kmap(164),kcrust_7 ),(kmap(165),kcrust_8 ),
     &(kmap(166),kcrust_9 ),(kmap(167),kcrust_10),(kmap(168),kph2o_1  ),
     &(kmap(169),kph2o_2  ),(kmap(170),kph2o_3  ),(kmap(171),kph2o_4  ),
     &(kmap(172),kph2o_5  ),(kmap(173),kph2o_6  ),(kmap(174),kph2o_7  ),
     &(kmap(175),kph2o_8  ),(kmap(176),kph2o_9  ),(kmap(177),kph2o_10 ),
     &(kmap(178),kpcl_1   ),(kmap(179),kpcl_2   ),(kmap(180),kpcl_3   ),
     &(kmap(181),kpcl_4   ),(kmap(182),kpcl_5   ),(kmap(183),kpcl_6   ),
     &(kmap(184),kpcl_7   ),(kmap(185),kpcl_8   ),(kmap(186),kpcl_9   ),
     &(kmap(187),kpcl_10  ),(kmap(188),kna_1    ),(kmap(189),kna_2    ),
     &(kmap(190),kna_3    ),(kmap(191),kna_4    ),(kmap(192),kna_5    ),
     &(kmap(193),kna_6    ),(kmap(194),kna_7    ),(kmap(195),kna_8    ),
     &(kmap(196),kna_9    ),(kmap(197),kna_10   ),(kmap(198),kpnh4_1  ),
     &(kmap(199),kpnh4_2  ),(kmap(200),kpnh4_3  ),(kmap(201),kpnh4_4  ),
     &(kmap(202),kpnh4_5  ),(kmap(203),kpnh4_6  ),(kmap(204),kpnh4_7  ),
     &(kmap(205),kpnh4_8  ),(kmap(206),kpnh4_9  ),(kmap(207),kpnh4_10 ),
     &(kmap(208),kpno3_1  ),(kmap(209),kpno3_2  ),(kmap(210),kpno3_3  ),
     &(kmap(211),kpno3_4  ),(kmap(212),kpno3_5  ),(kmap(213),kpno3_6  ),
     &(kmap(214),kpno3_7  ),(kmap(215),kpno3_8  ),(kmap(216),kpno3_9  ),
     &(kmap(217),kpno3_10 ),(kmap(218),kpso4_1  ),(kmap(219),kpso4_2  ),
     &(kmap(220),kpso4_3  ),(kmap(221),kpso4_4  ),(kmap(222),kpso4_5  ),
     &(kmap(223),kpso4_6  ),(kmap(224),kpso4_7  ),(kmap(225),kpso4_8  ),
     &(kmap(226),kpso4_9  ),(kmap(227),kpso4_10 ),(kmap(228),kph2o    )
c
